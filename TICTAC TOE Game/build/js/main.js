...
const playAgain = document.querySelector('.ending__playAgain-btn');
...
const timing = setInterval(() => {
    if (boxes[0].innerHTML !== '' && boxes[1].innerHTML !== '' && boxes[2].innerHTML !== '' && boxes[3].innerHTML !== '' && boxes[4].innerHTML !== '' && boxes[5].innerHTML !== '' && boxes[6].innerHTML !== '' && boxes[7].innerHTML !== '' && boxes[8].innerHTML !== '') {
        ...
        let endingText = document.querySelector('.ending__text');
    ...
    ;
    let box = document.querySelector('[data-id="0"]');
    let box1 = document.querySelector('[data-id="1"]');
    let box2 = document.querySelector('[data-id="2"]');
    let box3 = document.querySelector('[data-id="3"]');
    let box4 = document.querySelector('[data-id="4"]');
    let box5 = document.querySelector('[data-id="5"]');
    let box6 = document.querySelector('[data-id="6"]');
    let box7 = document.querySelector('[data-id="7"]');
    let box8 = document.querySelector('[data-id="8"]');
